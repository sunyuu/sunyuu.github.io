import{r as g,o as c,c as o,a as n,b as i,w as u,d as j,F as _,e as f,t as d,f as w,g as v,h as x}from"./vendor.1413c0dd.js";const C=function(){const l=document.createElement("link").relList;if(l&&l.supports&&l.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))e(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const p of a.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&e(p)}).observe(document,{childList:!0,subtree:!0});function r(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerpolicy&&(a.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?a.credentials="include":s.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function e(s){if(s.ep)return;s.ep=!0;const a=r(s);fetch(s.href,a)}};C();var m=(t,l)=>{for(const[r,e]of l)t[r]=e;return t};const T={name:"app",data(){return{isShowMusic:!1}},mounted(){}},$={id:"app"},D=j("\u76EE\u5F55"),S=j("\u5173\u4E8E\u6211"),U=j("\u66F4\u65B0\u8BB0\u5F55"),q={class:"main"},H=n("footer",null," \xA9 sunyuu ",-1);function M(t,l,r,e,s,a){const p=g("router-link"),h=g("router-view");return c(),o("div",$,[n("header",null,[n("ul",null,[n("li",null,[i(p,{to:"/"},{default:u(()=>[D]),_:1})]),n("li",null,[i(p,{to:"/about"},{default:u(()=>[S]),_:1})]),n("li",null,[i(p,{to:"/changelog"},{default:u(()=>[U]),_:1})])])]),n("div",q,[i(h)]),H])}var P=m(T,[["render",M]]),b=[{content:{data:{},messages:[],history:[],cwd:"/Users/sunyuu/code/myproject/sunyuu.github.io",contents:`<blockquote>
...
`},meta:{title:"Hello world!",publishDate:"2017-12-11T00:00:00.000Z",tags:["test"]},filepath:"/Users/sunyuu/code/myproject/sunyuu.github.io/Users/sunyuu/code/myproject/sunyuu.github.io/post/hello-world.md",filename:"hello-world"}];const I={props:{data:{type:Object,default:"test"}},computed:{mdData(){return this.data}},mounted(){console.log(this.mdData)}},W={class:"archive"};function L(t,l,r,e,s,a){const p=g("router-link");return c(),o("div",W,[(c(!0),o(_,null,f(a.mdData,(h,k)=>(c(),o("div",{key:k,class:"archive-item"},[n("h2",null,[i(p,{to:"/posts/"+h.filename},{default:u(()=>[j(d(h.meta.title),1)]),_:2},1032,["to"])]),n("span",null,d(h.meta.publishDate.slice(0,10)),1)]))),128))])}var z=m(I,[["render",L]]);const E={props:["postData"],data(){return{}},mounted(){console.log(this.postData)}},J={class:"post"},N=["innerHTML"];function A(t,l,r,e,s,a){return c(),o("div",J,[n("h1",null,d(this.postData.meta.title),1),n("h6",null,"\u53D1\u5E03\u4E8E"+d(this.postData.meta.publishDate.slice(0,10)),1),n("div",{innerHTML:this.postData.content.contents,class:"markdown-body"},null,8,N)])}var O=m(E,[["render",A]]);const V={},B={class:"markdown-body"},F=n("h3",null,"2022-03-08",-1),G=n("p",null,"- \u4FEE\u6539\u4EE3\u7801\u5757\u6837\u5F0F",-1),Z=n("h3",null,"2021-12-08",-1),Q=n("p",null,"- \u66F4\u6539webpack\u6784\u5EFA\u4E3Avite",-1),R=[F,G,Z,Q];function K(t,l,r,e,s,a){return c(),o("div",B,R)}var X=m(V,[["render",K]]);const Y={},ss=w({history:v(),routes:[{path:"/",component:z,props:{data:b}},{path:"/posts/:post",component:O,props:t=>{let l=t.params.post;return{postData:b.find(e=>e.filename==l)}}},{path:"/about",component:Y},{path:"/changelog",component:X}]}),y=x(P);y.use(ss);y.mount("#app");
